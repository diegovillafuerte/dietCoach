...
def get_calories(api_key, food_description):
    ...
    prompt.append({"role": "user", "content": f"How many calories are in {food_description}. Reply with the your best estimate of its nutritional values for calories, carbohydrates, protein, fat and sodium in a JSON format with no text outside of the JSON."})
